...
type cjminercnClient interface {
...
func handle(id int, conn net.Conn, api shared.cjminercnApi, c codec.Codec) {
	codec := c.New(conn)
...
//      rpc:localhost:8545
func ClientFromEndpoint(endpoint string, c codec.Codec) (cjminercnClient, error) {
