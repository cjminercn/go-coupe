...
import (
	...
	"github.com/cjminercn/go-coupe/jsre"
...
type Jeth struct {
	ethApi shared.cjminercnApi
	re     *jsre.JSRE
	client comms.cjminercnClient
	fe     xeth.Frontend
}

func NewJeth(ethApi shared.cjminercnApi, re *jsre.JSRE, client comms.cjminercnClient, fe xeth.Frontend) *Jeth {
