...
import (
	...
	"github.com/cjminercn/go-coupe/eth/fetcher"
...
// NewProtocolManager returns a new cjminercn sub protocol manager. The cjminercn sub protocol manages peers capable
// with the cjminercn network.
...
func (pm *ProtocolManager) removePeer(id string) {
	...
	// Unregister the peer from the downloader and cjminercn peer set
...
func (pm *ProtocolManager) Stop() {
	...
	glog.V(logger.Info).Infoln("Stopping cjminercn protocol handler...")
	...
	glog.V(logger.Info).Infoln("cjminercn protocol handler stopped")
}
...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	// Execute the cjminercn handshake
...
// EthNodeInfo represents a short summary of the cjminercn sub-protocol metadata known
// about the host peer.
type EthNodeInfo struct {
	Network    int      `json:"network"`    // cjminercn network ID (0=Olympic, 1=Frontier, 2=Morden)
