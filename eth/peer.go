...
// PeerInfo represents a short summary of the cjminercn sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // cjminercn protocol version negotiated
