...
// package filters implements an cjminercn filtering system for block,
...
// for specific LOG events fired by the EVM (cjminercn Virtual Machine).
...
// filterLoop waits for specific events from cjminercn and fires their handlers
