 ...
 * @param {String} type
 * @returns {Number} length of dynamic type, 0 or multiplication of nch_PADDING (32)
 */
var dynamicBytesLength = function (type) {
    if (isArrayType(type) || type === 'bytes')
        return c.nch_PADDING * 2;
    return 0;
};
...
var formatInputInt = function (value) {
    var padding = c.nch_PADDING * 2;
    BigNumber.config(c.nch_BIGNUMBER_ROUNDING_MODE);
...
var formatInputString = function (value) {
    return utils.fromAscii(value, c.nch_PADDING).substr(2);
};
...
/// required to define nch_BIGNUMBER_ROUNDING_MODE
var BigNumber = require('bignumber.js');
...
module.exports = {
    nch_PADDING: 32,
    nch_SIGNATURE_LENGTH: 4,
    nch_UNITS: nch_UNITS,
    nch_BIGNUMBER_ROUNDING_MODE: { ROUNDING_MODE: BigNumber.ROUND_DOWN },
    nch_POLLING_TIMEOUT: 1000,
    nch_DEFAULTBLOCK: 'latest'
};
