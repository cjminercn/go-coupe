...
[![Build
Status](https://travis-ci.org/cjminercn/go-coupe.png?branch=master)](https://travis-ci.org/cjminercn/go-coupe)

The common package contains the cjminercn utility library.

# Installation

As a subdirectory the main go-coupe repository, you get it with
`go get github.com/cjminercn/go-coupe`.

# Usage

## RLP (Recursive Linear Prefix) Encoding

RLP Encoding is an encoding scheme used by the cjminercn project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.cjminercn.org/index.php/RLP) article.
...
Patricie Tree is a merkle trie used by the cjminercn project.

More in depth information about the (modified) Patricia Trie can be
found on the [Wiki](http://wiki.cjminercn.org/index.php/Patricia_Tree).
