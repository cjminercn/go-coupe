...
module.exports = function (str, isNew) {
    if (str.substr(0, 2) === '0x' && !isNew) {
        ...
        console.warn('see https://github.com/cjminercn/web3.js/pull/205');
...
var web3Properties = [
    ...
    new Property({
        name: 'version.cjminercn',
        getter: 'nch_protocolVersion',
        inputFormatter: utils.toDecimal
    }),
    new Property({
...
SolidityFunction.prototype.request = function () {
    ...
    return {
        method: this._constant ? 'nch_call' : 'nch_sendTransaction',
        callback: callback,
        params: [payload],
        format: format
    };
...
/**
 * This method should be used to create iban object from cjminercn address
 *
 * @method fromAddress
 * @param {String} address
...
var blockCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? "nch_getBlockByHash" : "nch_getBlockByNumber";
};

var transactionFromBlockCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'nch_getTransactionByBlockHashAndIndex' : 'nch_getTransactionByBlockNumberAndIndex';
};

var uncleCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'nch_getUncleByBlockHashAndIndex' : 'nch_getUncleByBlockNumberAndIndex';
};

var getBlockTransactionCountCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'nch_getBlockTransactionCountByHash' : 'nch_getBlockTransactionCountByNumber';
};

var uncleCountCall = function (args) {
    return (utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'nch_getUncleCountByBlockHash' : 'nch_getUncleCountByBlockNumber';
};
...
var getTransactionReceipt = new Method({
    ...
    call: 'nch_getTransactionReceipt',
    params: 1,
...
var eth = function () {
    var newFilterCall = function (args) {
        ...
        switch(type) {
            case 'latest':
                args.shift();
                this.params = 0;
                return 'nch_newBlockFilter';
            case 'pending':
                args.shift();
                this.params = 0;
                return 'nch_newPendingTransactionFilter';
            default:
                return 'nch_newFilter';
        }
    };
    ...
    var uninstallFilter = new Method({
        ...
        call: 'nch_uninstallFilter',
        params: 1
    });

    var getLogs = new Method({
        name: 'getLogs',
        call: 'nch_getFilterLogs',
        params: 1
    });

    var poll = new Method({
        name: 'poll',
        call: 'nch_getFilterChanges',
        params: 1
    });
 ...
 * It's also responsible for polling the cjminercn node for incoming messages
...
RequestManager.prototype.poll = function () {
    /*jshint maxcomplexity: 6 */
    this.timeout = setTimeout(this.poll.bind(this), c.nch_POLLING_TIMEOUT);
