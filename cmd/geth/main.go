...
// geth is the official command-line client for cjminercn.
package main
...
func init() {
	...
	app = utils.NewApp(Version, "the go-coupe command line interface")
	app.Action = run
...
`,
		},
		{
			Action: version,
			Name:   "version",
			Usage:  "print cjminercn version numbers",
			Description: `
...
`,
		...
		{
			Name:  "wallet",
			Usage: "cjminercn presale wallet",
			Subcommands: []cli.Command{
				{
					Action: importWallet,
					Name:   "import",
					Usage:  "import cjminercn presale wallet",
				},
			},
			Description: `
...
between cjminercn nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    cjminercn --password <passwordfile> account new
...
password to file or expose in any other way.
    ...
    cjminercn account update <address>
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    cjminercn --password <passwordfile> account update <address>
...
changes.
    ...
    cjminercn account import <keyfile>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    cjminercn --password <passwordfile> account import <keyfile>

Note:
As you can directly copy your encrypted accounts to another cjminercn instance,
...
See https://github.com/cjminercn/go-coupe/wiki/Javascipt-Console
`},
		{
			Action: attach,
			Name:   "attach",
...
JavaScript API. See https://github.com/cjminercn/go-coupe/wiki/Javascipt-Console
`,
		},
	}
	app.Flags = []cli.Flag{
...
func attach(ctx *cli.Context) {
	var client comms.cjminercnClient
	var err error
	if ctx.Args().Present() {
...
func startEth(ctx *cli.Context, eth *eth.cjminercn) {
	// Start cjminercn itself
	utils.Startcjminercn(eth)
