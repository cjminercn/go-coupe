...
import (
	...
	"github.com/cjminercn/go-coupe/event/filter"
...
// Whisper represents a dark communication interface through the cjminercn
...
// New creates a Whisper client ready to communicate through the cjminercn P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
