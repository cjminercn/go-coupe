...
mine(PyObject *self, PyObject *args) {
    ...
    do {
        ...
        // TODO: disagrees with the spec https://github.com/cjminercn/wiki/wiki/Ethash#mining
...
static PyMethodDef PyethashMethods[] =
        {
                ...
                /*{"hashimoto_full", hashimoto_full, Mnch_VARARGS,
...
PyMODINIT_FUNC PyInit_pyethash(void) {
    ...
    // Following Spec: https://github.com/cjminercn/wiki/wiki/Ethash#definitions
