...
// Package core implements the cjminercn consensus protocol.
package core
...
// available in the database. It initialiser the default cjminercn Validator and
// Processor.
func NewBlockChain(chainDb ethdb.Database, pow pow.PoW, mux *event.TypeMux) (*BlockChain, error) {
	...
	if bc.genesisBlock == nil {
		...
		glog.V(logger.Info).Infoln("WARNING: Wrote default cjminercn genesis block")
	}
